 ...
 * 
 */
package org.opennaas.itests.ws.utils;

import javax.xml.ws.BindingProvider;

import org.opennaas.ws.ChassisCapabilityService;
import org.opennaas.ws.ConnectionsCapabilityService;
...
import org.opennaas.ws.MonitoringCapabilityService;
...
public class OpennaasClient {
	...
	public static IQueueManagerCapabilityService getQueueManagerCapabilityService() {
		QueueManagerCapabilityService qmService = new QueueManagerCapabilityService();
		IQueueManagerCapabilityService proxy = qmService.getQueueManagerCapabilityPort();
	...
	public static IConnectionsCapabilityService getConnectionsCapabilityService() {
		ConnectionsCapabilityService connectionsService = new ConnectionsCapabilityService();
		IConnectionsCapabilityService proxy = connectionsService.getConnectionsCapabilityPort();
		((BindingProvider) proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, endpoint + "connectionsCapabilityService?wsdl");
		return proxy;
	}

	public static IMonitoringCapabilityService getMonitoringCapabilityService() {
		MonitoringCapabilityService monitoringService = new MonitoringCapabilityService();
		IMonitoringCapabilityService proxy = monitoringService.getMonitoringCapabilityPort();
		((BindingProvider) proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, endpoint + "monitoringCapabilityService?wsdl");
		return proxy;
	}
