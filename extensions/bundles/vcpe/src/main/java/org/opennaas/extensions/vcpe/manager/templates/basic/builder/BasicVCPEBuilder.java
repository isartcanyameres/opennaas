...
import org.opennaas.extensions.vcpe.manager.templates.builder.IVCPEBuilder;
...
public class BasicVCPEBuilder implements IVCPEBuilder {

	Log	log	= LogFactory.getLog(BasicVCPEBuilder.class);
	...
	public VCPEBuilderResult build(VCPEBuilderParameters parameters) throws ResourceException {
		...
		VCPENetworkModel model = buildDesiredScenario(((BasicVCPEBuilderParameters) parameters).getModel());

		VCPEBuilderResult result = new VCPEBuilderResult();
	...
	public VCPEBuilderResult unbuild(VCPENetworkModel currentModel) throws ResourceException {
		...
		VCPENetworkModel model = unbuildScenario(currentModel);
	...
	private void checkParameters(VCPEBuilderParameters parameters) throws ResourceException {
		if (!(parameters instanceof BasicVCPEBuilderParameters))
			throw new ResourceException("Invalid parametrs type. BasicVCPEBuilderparameters expected");
	}

	private VCPENetworkModel buildDesiredScenario(VCPENetworkModel desiredScenario) throws ResourceException {

		createExternalLinks(desiredScenario);
		...
		createLogicalRouters(desiredScenario);
		...
		startLogicalRouters(desiredScenario);

		createSubInterfaces(desiredScenario);

		assignIPAddresses(desiredScenario);
		...
		configureEGP(desiredScenario);

		configureVRRP(desiredScenario);
		...
		desiredScenario.setCreated(true);
		return desiredScenario;
	}

	private VCPENetworkModel unbuildScenario(VCPENetworkModel currentScenario) throws ResourceException {

		unconfigureEGP(currentScenario);

		// not necessary because subinterfaces will be removed afterwards
		// removeIPAddresses(resource, currentScenario);

		stopLogicalRouters(currentScenario);

		removeLogicalRouters(currentScenario);

		removeSubInterfaces(currentScenario);
		...
		destroyExternalLinks(currentScenario);
	...
	private void createLogicalRouters(VCPENetworkModel desiredScenario) throws ResourceException {
	...
	private void removeLogicalRouters(VCPENetworkModel desiredScenario) throws ResourceException {
	...
	private void createSubInterfaces(VCPENetworkModel desiredScenario) throws ResourceException {
	...
	private void removeSubInterfaces(VCPENetworkModel currentScenario) throws ResourceException {
	...
	private void assignIPAddresses(VCPENetworkModel model) throws ResourceException {
	...
	private void configureEGP(VCPENetworkModel model) throws ResourceException {
	...
	private void unconfigureEGP(VCPENetworkModel model) throws ResourceException {
		// only static routes by now
		unconfigureStaticRoutes(model);
	}

	private void configureStaticRoutes(VCPENetworkModel model) throws ResourceException {
		...
		configureStaticRoutesInClient(model);
	}

	private void unconfigureStaticRoutes(VCPENetworkModel model) throws ResourceException {
	...
	private void unconfigureStaticRoutesInClient(VCPENetworkModel model) throws ResourceException {
		Router lr1 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.VCPE1_ROUTER);
	...
	private void unconfigureStaticRoutesInProvider(VCPENetworkModel model) throws ResourceException {
	...
	private void configureStaticRoutesInProvider(VCPENetworkModel model) throws ResourceException {
		Router phy1 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.CPE1_PHY_ROUTER);
		Interface iface1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.UP1_INTERFACE_LOCAL);
	...
	private void configureStaticRoutesInClient(VCPENetworkModel model) throws ResourceException {
		Router lr1 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.VCPE1_ROUTER);
		Interface iface1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.UP1_INTERFACE_PEER);
	...
	private void startLogicalRouters(VCPENetworkModel model) throws ResourceException {
	...
	private void stopLogicalRouters(VCPENetworkModel model) throws ResourceException {
		Router lr1 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.VCPE1_ROUTER);
		Router lr2 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, VCPETemplate.VCPE2_ROUTER);
	...
	private void createExternalLinks(VCPENetworkModel model) throws ResourceException {
	...
	private void destroyExternalLinks(VCPENetworkModel model) throws ResourceException {
	...
	private void configureVRRP(VCPENetworkModel model) throws ResourceException {
	...
	// TODO
	private void unconfigureVRRP(VCPENetworkModel model) throws ResourceException {
