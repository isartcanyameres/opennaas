...
public class NetworkMapperDescriptorToModel {
	...
	public static NetworkModel descriptorToModel(NetworkTopology networkTopology) throws ResourceException {
		...
		List<org.opennaas.extensions.model.ndl.topology.Device> existingDevices = new ArrayList<org.opennaas.extensions.model.ndl.topology.Device>();
		List<org.opennaas.extensions.model.ndl.topology.ConnectionPoint> existingInterfaces = new ArrayList<org.opennaas.extensions.model.ndl.topology.ConnectionPoint>();
		List<org.opennaas.extensions.model.ndl.topology.Link> existingLinks = new ArrayList<org.opennaas.extensions.model.ndl.topology.Link>();
		List<org.opennaas.extensions.model.ndl.domain.NetworkDomain> existingDomains = new ArrayList<org.opennaas.extensions.model.ndl.domain.NetworkDomain>();
		...
		if (networkTopology.getInterfaces() != null) {
			...
			for (Interface interf : networkTopology.getInterfaces()) {
				...
				org.opennaas.extensions.model.ndl.topology.Interface sourceInterf = (org.opennaas.extensions.model.ndl.topology.Interface) existingInterfaces
						.get(sourcePosInterf);
				...
				if (targetPosInterf == -1) {
					...
					org.opennaas.extensions.model.ndl.topology.Interface newInterf = new org.opennaas.extensions.model.ndl.topology.Interface();
					newInterf.setName((interf.getLinkTo().getName()));
					existingInterfaces.add(newInterf);
					targetPosInterf = existingInterfaces.size() - 1;
				}

				org.opennaas.extensions.model.ndl.topology.Interface targetInterf = (org.opennaas.extensions.model.ndl.topology.Interface) existingInterfaces
						.get(targetPosInterf);
		...
		if (networkTopology.getDevices() != null) {
			...
			for (Device device : networkTopology.getDevices()) {
				...
				for (InterfaceId interfaceId : device.getHasInterfaces()) {
					...
					org.opennaas.extensions.model.ndl.topology.Interface sourceInterf =
							(org.opennaas.extensions.model.ndl.topology.Interface) existingInterfaces.get(posInterf);
		...
		if (networkTopology.getNetworkDomains() != null) {
			...
			for (NetworkDomain networkDomainModel : networkTopology.getNetworkDomains()) {
				org.opennaas.extensions.model.ndl.domain.NetworkDomain networkDomain = new org.opennaas.extensions.model.ndl.domain.NetworkDomain();
				networkDomain.setName(networkDomainModel.getName());
				List<org.opennaas.extensions.model.ndl.topology.Device> devices = new ArrayList<org.opennaas.extensions.model.ndl.topology.Device>();
				for (DeviceId deviceId : networkDomainModel.getHasDevices()) {
					...
					org.opennaas.extensions.model.ndl.topology.Device modelDevice = existingDevices.get(posDevice);
		...
		// add interfaces
		// List<org.opennaas.extensions.model.ndl.topology.ConnectionPoint> interfaces = new
		// ArrayList<org.opennaas.extensions.model.ndl.topology.ConnectionPoint>();
		...
		// throw new ResourceException("Error to fill network model. Interface doesn't exist: " + interfaceId.getResource());
		//
		// org.opennaas.extensions.model.ndl.topology.Interface sourceInterf = (org.opennaas.extensions.model.ndl.topology.Interface)
		// existingInterfaces
		// .get(posInterf);
		// interfaces.add(sourceInterf);
		// }
	...
	private static boolean thereIsALinkToInterface(org.opennaas.extensions.model.ndl.topology.Interface targetInterf, List<Link> existingLinks) {
	...
	private static void linkInterfaces(org.opennaas.extensions.model.ndl.topology.Interface sourceInterf,
			org.opennaas.extensions.model.ndl.topology.Interface targetInterf,
			List<org.opennaas.extensions.model.ndl.topology.Link> existingLinks) throws ResourceException {

		if (targetInterf.getLinkTo() == null) {
			// It is the first interface of a link, a link should be created from source to target
			org.opennaas.extensions.model.ndl.topology.Link linkModel = NetworkModelHelper.linkInterfaces(sourceInterf, targetInterf, false);
	...
	private static org.opennaas.extensions.model.ndl.topology.Interface createInterface(String name) {
		org.opennaas.extensions.model.ndl.topology.Interface newInterf = new org.opennaas.extensions.model.ndl.topology.Interface();
	...
	private static int getNetworkResourceFromReference(String reference,
			List<? extends org.opennaas.extensions.model.ndl.topology.NetworkElement> networkElements) {
	...
	private static int getNetworkResourceByName(String name,
			List<? extends org.opennaas.extensions.model.ndl.topology.NetworkElement> networkElements) {
		int pos = 0;
		for (org.opennaas.extensions.model.ndl.topology.NetworkElement networkElement : networkElements) {
